...
func (s *lustreProcfsSource) generateOSTMetricTemplates(filter string) {
	metricMap := map[string][]lustreHelpStruct{
		"obdfilter/*": {
			...
			{"job_stats", "job_read_samples_total", readSamplesHelp, s.counterMetric, false, extended},
			{"job_stats", "job_read_minimum_size_bytes", readMinimumHelp, s.gaugeMetric, false, extended},
			{"job_stats", "job_read_maximum_size_bytes", readMaximumHelp, s.gaugeMetric, false, extended},
			{"job_stats", "job_read_bytes_total", readTotalHelp, s.counterMetric, false, extended},
			{"job_stats", "job_write_samples_total", writeSamplesHelp, s.counterMetric, false, extended},
			...
			{"job_stats", "job_write_bytes_total", writeTotalHelp, s.counterMetric, false, extended},
			{"job_stats", "job_stats_total", jobStatsHelp, s.counterMetric, true, extended},
